...
duk_ret_t JSRunner::jsLuLuCOMMAND_RIGHTHAND(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_RIGHTHAND, speed, tail_speed, "/imgs/eye3.gif", "/audio/woof3.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_HALFLAYDOWN(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_HALFLAYDOWN, speed, tail_speed, "/imgs/eye2.gif", "/audio/woof1.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_SET_TAIL_SPEED(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_SET_TAIL_SPEED, -1, tail_speed, nullptr, nullptr);
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_SIT(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_SIT, speed, tail_speed, "/imgs/eye1.gif", "/audio/woof2.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_LAYDOWN(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_LAYDOWN, speed, tail_speed, "/imgs/eye2.gif", "/audio/woof1.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_HAPPY(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_HAPPY, speed, tail_speed, "/imgs/eye3.gif", "/audio/woof3.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_DANCE1(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_DANCE1, speed, tail_speed, "/imgs/eye3.gif", "/audio/woof2.wav");
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_STAND(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_STAND, speed, tail_speed, "/imgs/eye3.gif", nullptr);
    return 0;
}
...
duk_ret_t JSRunner::jsLuLuCOMMAND_FULLLAYDOWN(duk_context *_ctx)
{
    ...
    luluDog->luluCharacter->doReactGif(COMMAND_FULLLAYDOWN, speed, tail_speed, "/imgs/eye6.gif", "/audio/woof3.wav");
    return 0;
}
